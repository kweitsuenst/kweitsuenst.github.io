...
<body>
    <header>   <img src="C:/data/mis logo.jpg" alt="" width=200 />
        <h1>Welcome to MIS AI  </h1>
       Computing is about learning how to use the computer to easy work,
...
-Using ai tools for problem solving
...
</li><pre><i>less time to work and acquiring life values.
</i></pre>
    ...
    <section id="curriculum">
        ...
        <a href="C:\data\Mission_International_School_Coding_AI_Curriculum.pdf">
    ...
    <section id="resources">
        ...
        <button type="button">Basic Three (3) </button>
         <button onclick="https://pmponline.co.in/codeai2023/ebook/CodeAI%20Book-3.pdf"></button>

    </section>

    <section id="projects">  <p>Learn from other students and projects samples in the AI department
          <img src="C:\data\MISAIPROJECTS.jpg" alt="Learn from other students and projects samples from the AI department" width=200  onclick=""/>
                                                                                            </p>
    ...
    <section id="blog">
        ...
        <a href="https://youtube.com/shorts/OK0YhF3NMpQ?si=yhkqNgM3JLovhTxx"> This is what the founder of Chatgpt said children should be learning at school </a>
    </section>
